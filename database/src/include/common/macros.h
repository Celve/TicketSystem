...
#define DECLARE(class_name)                                                                           \
  ...
  template class class_name<StringAny<int, 68>, int, StringAnyComparator<int, 68>>;      /* NOLINT */ \
  ...
  template class class_name<StringAny<int, 32>, DayTrain, StringAnyComparator<int, 32>>; /* NOLINT */ \
  template class class_name<StringAny<int, 32>, Order, StringAnyComparator<int, 32>>;    /* NOLINT */
...
#define DECLARE_BPLUSTREE_INTERNALPAGE(class_name)                                                     \
  ...
  template class class_name<StringAny<int, 32>, page_id_t, StringAnyComparator<int, 32>>; /* NOLINT */ \
  template class class_name<StringAny<int, 68>, page_id_t, StringAnyComparator<int, 68>>; /* NOLINT */
