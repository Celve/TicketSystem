...
// class Command
Command::Command(char _delimiter) { delimiter = _delimiter; }
...
ostream &operator<<(ostream &os, const Command &command) {
  os << "buffer: " << command.buffer << " cur: " << command.cur
     << " delimiter: " << command.delimiter;
  return os;
}

void Command::set_delimiter(char new_delimiter) { delimiter = new_delimiter; }
